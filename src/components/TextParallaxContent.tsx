...
const TextParallaxContentBlock = ({ imgUrl, subheading, heading, children }: TextParallaxContentProps) => {
  return (
...
const ExampleContent = () => (
  <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 px-4 pb-24 pt-12 md:grid-cols-12">
    ...
    <div className="col-span-1 md:col-span-8">
      ...
      <button className="w-full rounded bg-foreground px-9 py-4 text-xl text-background transition-colors hover:bg-foreground/80 md:w-fit">
